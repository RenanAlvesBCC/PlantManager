...
import {
    View, Alert, StyleSheet, Image, Platform, Text, SafeAreaView, TouchableOpacity, ScrollView
} from "react-native";
...
export function PlantSave() {
    ...
    async function handleSave() {
        ...
        try {
            ...
            navigation.navigate('Confirmation',{
                title: 'Tudo Certo! ',
                subtitle: 'Fique tranquilo, sempre vamos lembrar você de cuidar da sua plantinha com muito cuidado!',
    ...
    return (
        ...
        <SafeAreaView style={styles.container}>
            ...
            {Platform.OS === 'android' && (
                <TouchableOpacity style={styles.button} onPress={() => handleOpenDatePickerForAndroid()}>
